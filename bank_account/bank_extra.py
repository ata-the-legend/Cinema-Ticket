...
def delete(serial: str) -> None:
    ...
    :param serial: username of user account
    :return: None
    """
    dic = get_database()
    del dic[serial]
...
def get_object(serial: str) -> dict | None:
    """
    get object from database
    :param serial: username
    :return: user object
    """
    try:
        with open("bank_accounts.json", "r") as fp:
            ...
            bank_account = bank_accounts[serial]
            return bank_account
    except Exception:
        return None
