...
def get_cinema_database() -> dict:
    try:
        with open("cinema/json/cinema.json", "r") as fp:
...
def save_cinema(cinema: dict) -> None:
    ...
    try:
        with open("cinema/json/cinema.json", "w") as fp:
...
def get_movie_database() -> dict:
    try:
        with open("cinema/json/movie.json", "r") as fp:
            # Load the dictionary from the file
            return json.load(fp)
    except Exception as ex:
        print('You have error in get cinema-database', ex)
...
def save_movie(movie: dict) -> None:
    ...
    try:
        with open("cinema/json/movie.json", "w") as fp:
            json.dump(dic, fp, indent=4)  # encode dict into JSON
    except Exception as ex:
        print('You have error', ex)
...
def get_salon_database() -> dict:
    try:
        with open("cinema/json/salon.json", "r") as fp:
            # Load the dictionary from the file
            return json.load(fp)
    except Exception as ex:
        print('You have error in get cinema-database', ex)
...
def save_salon(salon: dict) -> None:
    ...
    try:
        with open("cinema/json/salon.json", "w") as fp:
            json.dump(dic, fp, indent=4)  # encode dict into JSON
    except Exception as ex:
        print('You have error', ex)
...
def get_session_database() -> dict:
    ...
    """
    try:
        with open("cinema/json/session.json", "r") as fp:
            # Load the dictionary from the file
            return json.load(fp)
    except Exception as ex:
        print('You have error in get cinema-database', ex)
...
def save_session(session: dict) -> None:
    ...
    try:
        with open("cinema/json/session.json", "w") as fp:
            json.dump(dic, fp, indent=4)  # encode dict into JSON
    except Exception as ex:
        print('You have error', ex)
...
def get_ticket_database() -> dict:
    try:
        with open("cinema/json/ticket.json", "r") as fp:
            # Load the dictionary from the file
            return json.load(fp)
    except Exception as ex:
        print('You have error in get cinema-database', ex)
...
def save_ticket(ticket: dict) -> None:
    ...
    try:
        with open("cinema/json/ticket.json", "w") as fp:
            json.dump(dic, fp, indent=4)  # encode dict into JSON
    except Exception as ex:
        print('You have error', ex)
...
def get_user_subscription_database() -> dict:
    try:
        with open("cinema/json/user_subscription.json", "r") as fp:
            # Load the dictionary from the file
            return json.load(fp)
    except Exception as ex:
        print('You have error in get cinema-database', ex)
...
def save_user_subscription(user_subscription: dict) -> None:
    ...
    try:
        with open("cinema/json/user_subscription.json", "w") as fp:
            json.dump(dic, fp, indent=4)  # encode dict into JSON
    except Exception as ex:
        print('You have error', ex)
